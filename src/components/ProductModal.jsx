...
const ProductModal = ({modalMode, tempProduct, isOpen, setIsOpen, getProducts}) => {
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <div className="mb-3">
                                ...
                                <input value={modalData.title} onChange={handleModalInputChange} name='title' type="text" className="form-control" id="title" placeholder='請輸入標題' required/>
                            </div>

                            <div className="mb-3">
                                <label htmlFor="category" className="form-label">分類</label>
                                <input value={modalData.category} onChange={handleModalInputChange} name='category' type="text" className="form-control" id="category" placeholder='請輸入分類' required/>
                            </div>

                            <div className="mb-3">
                                <label htmlFor="unit" className="form-label">單位</label>
                                <input value={modalData.unit} onChange={handleModalInputChange} name='unit' type="text" className="form-control" id="unit" placeholder='請輸入單位' required/>
                            </div>

                            <div className="row mb-3">
                                <div className="col-6">
                                <label htmlFor="origin_price" className="form-label">原價</label>
                                <input min={0} value={modalData.origin_price} onChange={handleModalInputChange} name='origin_price' type="number" className="form-control" id="origin_price" placeholder='請輸入原價'/>
                                </div>

                                <div className="col-6">
                                <label htmlFor="price" className="form-label">售價</label>
                                <input min={0} value={modalData.price} onChange={handleModalInputChange} name='price' type="number" className="form-control" id="price" placeholder='請輸入售價'/>
                                </div>
                            </div>

                            <div className="mb-3">
                                <label htmlFor="description" className="form-label">產品描述</label>
                                <textarea value={modalData.description} onChange={handleModalInputChange} row={10} cols={30} name="description" id="description" className="form-control" placeholder='請輸入產品描述'></textarea>
                            </div>

                            <div className="mb-3 d-flex flex-column">
                                <label htmlFor="content" className="form-label">說明內容</label>
                                <textarea value={modalData.content} onChange={handleModalInputChange} row={10} cols={30}  name="content" id="content" className='form-ocntrol' placeholder='請輸入說明內容'></textarea>
                            </div>
